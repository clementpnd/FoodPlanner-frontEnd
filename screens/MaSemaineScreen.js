...
// variables d'états pour le nb de personnes par jour
  const [nbPersonneProfil, setNbPersonneProfil] = useState("10");; // rappel du nb de personnes enrgistrées dans le profil
  ...
  const [nbPersonneMercredi, setNbPersonneMercredi] = useState(nbPersonneProfil);
  const [nbPersonneJeudi, setNbPersonneJeudi] = useState(nbPersonneProfil);
  const [nbPersonneVendredi, setNbPersonneVendredi] = useState(nbPersonneProfil);
  const [nbPersonneSamedi, setNbPersonneSamedi] = useState(nbPersonneProfil);
  const [nbPersonneDimanche, setNbPersonneDimanche] = useState(nbPersonneProfil);
...
const listData = [
  ...
  { rang: "6", jour: "Mercredi", value: "Midi", nbPersonne: nbPersonneMercredi},
  { rang: "7", jour: "Mercredi", value: "Soir", nbPersonne: nbPersonneMercredi},
  { rang: "8", jour: "Mercredi", value: "lesdeux", nbPersonne: nbPersonneMercredi},
  { rang: "9", jour: "Jeudi", value: "Midi", nbPersonne: nbPersonneJeudi},
  { rang: "10", jour: "Jeudi", value: "Soir", nbPersonne: nbPersonneJeudi},
  { rang: "11", jour: "Jeudi", value: "lesdeux", nbPersonne: nbPersonneJeudi},
  { rang: "12", jour: "Vendredi", value: "Midi", nbPersonne: nbPersonneVendredi},
  { rang: "13", jour: "Vendredi", value: "Soir", nbPersonne: nbPersonneVendredi},
  { rang: "14", jour: "Vendredi", value: "lesdeux", nbPersonne: nbPersonneVendredi},
  { rang: "15", jour: "Samedi", value: "Midi", nbPersonne: nbPersonneSamedi},
  { rang: "16", jour: "Samedi", value: "Soir", nbPersonne: nbPersonneSamedi},
  { rang: "17", jour: "Samedi", value: "lesdeux", nbPersonne: nbPersonneSamedi},
  { rang: "18", jour: "Dimanche", value: "Midi", nbPersonne: nbPersonneDimanche},
  { rang: "19", jour: "Dimanche", value: "Soir", nbPersonne: nbPersonneDimanche},
  { rang: "20", jour: "Dimanche", value: "lesdeux", nbPersonne: nbPersonneDimanche},
];
  ...
  const [checkboxStateMercrediMidi, setCheckboxStateMercrediMidi] = useState(false);
  const [checkboxStateMercrediSoir, setCheckboxStateMercrediSoir] = useState(false);
  const [checkboxStateMercrediDeux, setCheckboxStateMercrediDeux] = useState(false);
  ...
  const [checkboxStateVendrediMidi, setCheckboxStateVendrediMidi] = useState(false);
  const [checkboxStateVendrediSoir, setCheckboxStateVendrediSoir] = useState(false);
  const [checkboxStateVendrediDeux, setCheckboxStateVendrediDeux] = useState(false);
  ...
  const [checkboxStateDimancheMidi, setCheckboxStateDimancheMidi] = useState(false);
  const [checkboxStateDimancheSoir, setCheckboxStateDimancheSoir] = useState(false);
  const [checkboxStateDimancheDeux, setCheckboxStateDimancheDeux] = useState(false);
...
checkboxStateLundiMidi === true || checkboxStateLundiDeux === true ? allCheckBoxSelected.push(listData[0]) : allCheckBoxSelected.filter(d => d !== checkboxStateLundiMidi);
checkboxStateLundiSoir === true || checkboxStateLundiDeux === true ? allCheckBoxSelected.push(listData[1]) : allCheckBoxSelected.filter(d => d !== checkboxStateLundiSoir);
checkboxStateMardiMidi === true || checkboxStateMardiDeux === true ? allCheckBoxSelected.push(listData[3]) : allCheckBoxSelected.filter(d => d !== checkboxStateMardiMidi);
checkboxStateMardiSoir === true || checkboxStateMardiDeux === true ? allCheckBoxSelected.push(listData[4]) : allCheckBoxSelected.filter(d => d !== checkboxStateMardiSoir);
checkboxStateMercrediMidi === true || checkboxStateMercrediDeux === true ? allCheckBoxSelected.push(listData[6]) : allCheckBoxSelected.filter(d => d !== checkboxStateMercrediMidi);
checkboxStateMercrediSoir === true || checkboxStateMercrediDeux === true ? allCheckBoxSelected.push(listData[7]) : allCheckBoxSelected.filter(d => d !== checkboxStateMercrediSoir);
checkboxStateJeudiMidi === true || checkboxStateJeudiDeux === true ? allCheckBoxSelected.push(listData[9]) : allCheckBoxSelected.filter(d => d !== checkboxStateJeudiMidi);
checkboxStateJeudiSoir === true || checkboxStateJeudiDeux === true ? allCheckBoxSelected.push(listData[10]) : allCheckBoxSelected.filter(d => d !== checkboxStateJeudiSoir);
checkboxStateVendrediMidi === true || checkboxStateVendrediDeux === true ? allCheckBoxSelected.push(listData[12]) : allCheckBoxSelected.filter(d => d !== checkboxStateVendrediMidi);
checkboxStateVendrediSoir === true || checkboxStateVendrediDeux === true ? allCheckBoxSelected.push(listData[13]) : allCheckBoxSelected.filter(d => d !== checkboxStateVendrediSoir);
checkboxStateSamediMidi === true || checkboxStateSamediDeux === true ? allCheckBoxSelected.push(listData[15]) : allCheckBoxSelected.filter(d => d !== checkboxStateSamediMidi);
checkboxStateSamediSoir === true || checkboxStateSamediDeux === true ? allCheckBoxSelected.push(listData[16]) : allCheckBoxSelected.filter(d => d !== checkboxStateSamediSoir);
checkboxStateDimancheMidi === true || checkboxStateDimancheDeux === true ? allCheckBoxSelected.push(listData[18]) : allCheckBoxSelected.filter(d => d !== checkboxStateDimancheMidi);
checkboxStateDimancheSoir === true || checkboxStateDimancheDeux === true ? allCheckBoxSelected.push(listData[19]) : allCheckBoxSelected.filter(d => d !== checkboxStateDimancheSoir);

//dispatch
const handleOnSubmit = () => {
dispatch(addSemaine({allCheckBoxSelected}))
navigation.navigate("SemainierTest")
}
...
<SafeAreaView style={styles.container}>
  ...
  <ScrollView style={styles.scrollView}>
    ...
    <View style={styles.jour}>
        ...
        key={items}
         mode={'dropdown'} dropdownIconColor={'#E4631B'} 
        autoScroll={true}
        pickerStyleType={{justifyContent: "center"}}
        itemStyle={{fontFamily: "Fredoka"}}
          ref={pickerRef}
          selectedValue={nbPersonneProfil}
          onValueChange={(itemValue, itemPosition) => setNbPersonneLundi(itemValue)}>
          {Object.keys(items).map( eachItem => (
            <Picker.Item key={items}
      ...
      <View style={styles.rowCheckbox}>
        ...
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        unfillColor= "#fff"
    ...
    <View style={styles.jour}>
      ...
      <View style={styles.rowCheckbox}>
        ...
        text="Midi"
        onPress={() => setCheckboxStateMercrediMidi(!checkboxStateMercrediMidi)}
        />
        <BouncyCheckbox style={styles.checkbox}
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        ...
        text="Soir"
        onPress={() => setCheckboxStateMercrediSoir(!checkboxStateMercrediSoir)}
        />
        <BouncyCheckbox style={styles.checkbox}
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        ...
        text="Les 2"
        onPress={() => setCheckboxStateMercrediDeux(!checkboxStateMercrediDeux)}
        />  
    ...
    <View style={styles.jour}>
      ...
      <View style={styles.rowCheckbox}>
        ...
        text="Midi"
        onPress={() => setCheckboxStateVendrediMidi(!checkboxStateVendrediMidi)}
        />
        <BouncyCheckbox style={styles.checkbox}
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        ...
        text="Soir"
        onPress={() => setCheckboxStateVendrediSoir(!checkboxStateVendrediSoir)}
        />
        <BouncyCheckbox style={styles.checkbox}
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        ...
        text="Les 2"
        onPress={() => setCheckboxStateVendrediDeux(!checkboxStateVendrediDeux)}
        /> 
    ...
    <View style={styles.jour}>
      ...
      <View style={styles.rowCheckbox}>
        ...
        text="Midi"
        onPress={() => setCheckboxStateDimancheMidi(!checkboxStateDimancheMidi)}
        />
        <BouncyCheckbox style={styles.checkbox}
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        ...
        text="Soir"
        onPress={() => setCheckboxStateDimancheSoir(!checkboxStateDimancheSoir)}
        />
        <BouncyCheckbox style={styles.checkbox}
        textStyle={{fontFamily: "Fredoka", color: 'black', textDecorationLine: 'none',}}
        fillColor= "#E4631B"
        ...
        text="Les 2"
        onPress={() => setCheckboxStateDimancheDeux(!checkboxStateDimancheDeux)}
        /> 
